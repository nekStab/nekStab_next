      ...
      !     or any other scalar.
         ...
         real, dimension(lv) :: wavemaker, wk1, wk2
     ...
     $   vx_aIm, vy_aIm, vz_aIm, pr, t)
      ...
      !     --> Compute the wavemaker.
         wk1 = sqrt(vx_dRe**2 + vx_dIm**2 + vy_dRe**2 + vy_dIm**2 + vz_dRe**2 + vz_dIm**2)
         wk2 = sqrt(vx_aRe**2 + vx_aIm**2 + vy_aRe**2 + vy_aIm**2 + vz_aRe**2 + vz_aIm**2)
         wavemaker = wk1*wk2
